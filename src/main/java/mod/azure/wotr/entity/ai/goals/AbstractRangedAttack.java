...
public abstract class AbstractRangedAttack implements IRangedAttack {
	...
	public WoTREntity parentEntity;
	...
	public AbstractRangedAttack(WoTREntity parentEntity) {
		this.parentEntity = parentEntity;
	}

	public AbstractRangedAttack(WoTREntity parentEntity, double xOffSetModifier, double entityHeightFraction,
