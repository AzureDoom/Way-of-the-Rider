...
public class DrakeGauntletFireProjectile extends PersistentProjectileEntity implements IAnimatable {
	...
	public DrakeGauntletFireProjectile(EntityType<? extends DrakeGauntletFireProjectile> entityType, World world) {
		super(entityType, world);
		this.pickupType = PersistentProjectileEntity.PickupPermission.DISALLOWED;
	}

	public DrakeGauntletFireProjectile(World world, LivingEntity owner) {
		super(WoTREntities.DRAKE_GAUNTLET_FIRE, owner, world);
		this.shooter = owner;
	}

	protected DrakeGauntletFireProjectile(EntityType<? extends DrakeGauntletFireProjectile> type, double x, double y, double z, World world) {
		this(type, world);
	}

	protected DrakeGauntletFireProjectile(EntityType<? extends DrakeGauntletFireProjectile> type, LivingEntity owner, World world) {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<DrakeGauntletFireProjectile>(this, "controller", 0, this::predicate));
	}
		...
		for (int x = 0; x < list1.size(); ++x) {
			...
			if (y <= 1.0D) {
				if (entity.isAlive()) {
					...
					if (!(entity instanceof DrakeGauntletFireProjectile && this.getOwner() instanceof PlayerEntity)) {
